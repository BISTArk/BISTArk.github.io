...
const contactInfo = [
	{
		label: 'Email',
		value: 'akshaybistagond@gmail.com',
		href: 'mailto:akshaybistagond@gmail.com',
		icon: (
	...
	{
		label: 'GitHub',
		value: 'github.com/BISTArk',
		href: 'https://github.com/BISTArk',
		icon: (
	...
	{
		label: 'LinkedIn',
		value: 'linkedin.com/in/akshay-bistagond',
		href: 'https://linkedin.com/in/akshay-bistagond',
		icon: (
			<svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
